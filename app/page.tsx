      ...
      <section className="w-full p-4 h-full justify-center items-center flex relative flex-col">
        ...
        <div className="w-full flex flex-col justify-center z-20">
          ...
          <p className="text-center leading-7 text-slate-200 max-w-[600px] mt-5 mx-auto">
            ...
            explore your audience's locations. Optimize your sharing experience
            and have fun tracking clicks. Join me in this journey of discovery!
            🚀
          </p>

          <Link href={'auth/login/?route=login'} className="bg-white active:bg-white/75 text-black mx-auto px-9 py-2 mt-5 rounded-lg">
            Login
          </Link>
        </div>
      </section>
