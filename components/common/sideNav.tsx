...
const sideNav = () => {
  ...
  return (
    <aside className="h-screen flex-col flex justify-between w-[100px] bg-[#ffffff0a] border-r border-white/5">
      <Link
        href={"dashboard"}
      ...
      <div className="mb-10">
        <button className="bg-white w-[40px] active:bg-white/90 h-[40px] text-2xl flex items-center justify-center mx-auto rounded-full text-black">
          <GoPlus />
        </button>

        <button
          onClick={() => setOpenCreateUrlModal(true)}
          className="bg-white mt-10 w-[40px] active:bg-white/90 h-[40px] text-2xl flex items-center justify-center mx-auto rounded-full text-black"
        >
          <h1>😀</h1>
        </button>
